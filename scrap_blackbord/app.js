...
var credentials = { "user": "1324182@senati.pe", "password": "14deMayoRN2018" };
...
async function app() {
    ...
    for (var i = 0; i < __nex.length; i++) {
        ...
        //  console.log(__ex.length)

        //_examen.push(__ex[i]);

        //    console.log('====================================================================')

        //     console.log(__nex[i], url_)
        //     console.log('====================================================================')
        //     console.log(JSON.stringify(__ex))
        //     console.log('====================================================================')
        //     console.log(JSON.stringify(_examen));
    }
...
async function app() {
    ...
    async function open_ex(exam, url) {
        ...
        var examen = [];
        for (var i = 1; i <= parseInt(urls.cant); i++) {
            var dat = await open_tab(urls.url, i, browser);
            examen.push(dat)
        }
    ...
    async function open_tab(url, ex, browser) {
        let plataform = await browser.newPage();
        await plataform.setViewport({ width: 1200, height: 1000 });
        await plataform.goto(url);
        await plataform.waitForSelector('.attempt-grading-bar-inner.child-is-invokable');
